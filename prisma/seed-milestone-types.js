...
const MILESTONE_TYPES = [
    ...
    },
    {
        ...
        configSchema: { targetPercent: [5, 10, 25, 50, 75, 100] },
        isEnabled: true,
        order: 2,
    },
    {
    ...
    },
    {
        ...
        configSchema: { targetKm: [5, 10, 21.1, 42.2] },
        isEnabled: true,
        order: 4,
    },
    {
        ...
        configSchema: { targetWeeks: [1, 4, 12, 26, 52] },
        isEnabled: true,
        order: 5,
    },
    // Locked for now (set isEnabled: false)
    {
        ...
        configSchema: { targetCount: [10, 25, 50, 100] },
        isEnabled: false,
        order: 10,
    },
    {
    ...
    },
    {
        ...
        configSchema: { targetCount: [50, 100, 250, 500] },
        isEnabled: false,
        order: 13,
    },
    {
    ...
    },
    {
        ...
        configSchema: { targetCount: [1, 3, 5, 10] },
        isEnabled: false,
        order: 15,
    },
    {
        ...
        configSchema: { targetRuns: [3, 5, 10] },
        isEnabled: false,
        order: 16,
    },
    {
        ...
        configSchema: { count: 0, periodDays: 7 },
        isEnabled: false,
        order: 17,
    },
    {
        ...
        configSchema: { targetCount: [3, 5, 10] },
        isEnabled: false,
        order: 18,
    },
];
