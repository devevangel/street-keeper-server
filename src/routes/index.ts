 ...
 * | celebrations | /celebrations | Run celebration pending / Strava share |
 */
...
import celebrationsRoutes from "./celebrations.routes.js";
...
router.use("/celebrations", celebrationsRoutes);
